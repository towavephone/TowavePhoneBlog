...
function decryptAES () {
  ...
  try {
    ...
    if (content === '') {
      ...
      if (document.getElementById('tocButton')) {

        document.getElementById('tocButton').style.display = 'inline';

      }

      if (document.getElementById('miniArchives')) {

        document.getElementById('miniArchives').style.display = 'inline';
