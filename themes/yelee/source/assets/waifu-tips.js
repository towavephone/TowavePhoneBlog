...
function changeWife(){
    if(localStorage.getItem('wife') == 'live2d'){
        $('.live2d,.fui-eye,.fui-user,.fui-photo').hide();
        localStorage.setItem('wife', 'heimao');
        $('.profilepic').css('display','block');
        $('.fui-cross').attr('class','fui-heimao-cross');
    }else{
        $('.live2d,.fui-eye,.fui-user,.fui-photo').show();
        localStorage.setItem('wife', 'live2d');
        $('.profilepic').hide();
        $('.fui-heimao-cross').attr('class','fui-cross');
    }
}

function initWife(){
    if(localStorage.getItem('wife') == 'heimao'){
        $('.live2d,.fui-eye,.fui-user,.fui-photo').hide();
        $('.profilepic').css('display','block');
        $('.fui-cross').attr('class','fui-heimao-cross');
    }
...
// window.hitokotoTimer = window.setInterval(showHitokoto, 6000);
