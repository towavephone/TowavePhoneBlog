...
<div align="center">{% qnimg 5942debd-fc00-477a-b390-7c5692cc8070.jpg  %}</div>
...
<div align="center">{% qnimg GUID_Partition_Table_Scheme.svg.png  %}</div>
...
<div align="center">{% qnimg f900f266-a323-42b2-bc43-218fdb8811a8.jpg  %}</div>
...
<div align="center">{% qnimg 249f3bb1-feee-4805-a259-a72699d638ca.jpg  %}</div>
...
<div align="center">{% qnimg linux-filesystem.png  %}</div>
...
<div align="center">{% qnimg 658fc5e7-79c0-4247-9445-d69bf194c539.png %}</div>
...
<div align="center">{% qnimg ff0c019c-6461-467d-a266-0455341fd4f4.png  %}</div>
...
<div align="center">{% qnimg 1bfa3118-f3cd-4480-a950-cf6d646015db.png  %}</div>
...
<div align="center">{% qnimg 76a49594323247f21c9b3a69945445ee.png  %}</div>
...
<div align="center">{% qnimg flow.png %}</div>
...
<div align="center">{% qnimg 54cb3f21-485b-4159-8bf5-dcde1c4d4c36.png %}</div>
...
<div align="center">{% qnimg 5e9b10f3-9504-4483-9667-d4770adebf9f.png %}</div>
...
<div align="center">{% qnimg 1582217a-ed46-4cac-811e-90d13a65163b.png %}</div>

### 3. 异步-阻塞

这是 I/O 复用使用的一种模式，通过使用 select，它可以监听多个 I/O 事件，当这些事件至少有一个发生时，用户程序会收到通知。

<div align="center">{% qnimg dbc5c9f1-c13c-4d06-86ba-7cc949eb4c8f.jpg %}</div>

### 4. 异步-非阻塞

该模式下，I/O 操作会立即返回，之后可以处理其它操作，并且在 I/O 完成时会收到一个通知，此时会中断正在处理的操作，然后继续之前的操作。

<div align="center">{% qnimg b4b29aa9-dd2c-467b-b75f-ca6541cb25b5.jpg %}</div>
